...
class DropDownZakatMaal extends StatefulWidget {
  static String routeName;

  const DropDownZakatMaal({
    Key key,
    this.press,
  }) : super(key: key);
  final VoidCallback press;
  @override
  DropDownZakatMaalState createState() => DropDownZakatMaalState();
}
...
class DropDownZakatMaalState extends State<DropDownZakatMaal> {
